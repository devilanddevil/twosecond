    ...
    function twosecond_insert_lbc_rule($htaccess)
    {
        ...
        if (!empty($this->htaccessModifyKeys['lbc'])) {
            if ($this->twosecond_check_htaccess_status($data)) {
                ...
                $htaccess = $data . $htaccess;
                $this->twosecond_add_error('warning', 'Notice: Unable to verify .htaccess LBC rules via loopback request. Rules have been applied.');
            }
        } else {
            $htaccess = $data . $htaccess;
        }
    ...
    function twosecond_insert_gzip_rule($htaccess)
    {
        ...
        if (!empty($this->htaccessModifyKeys['gzip'])) {
            if ($this->twosecond_check_htaccess_status($data)) {
                ...
                $htaccess = $data . $htaccess;
                $this->twosecond_add_error('warning', 'Notice: Unable to verify .htaccess Gzip rules via loopback request. Rules have been applied.');
            }
        } else {
            $htaccess = $data . $htaccess;
        }
